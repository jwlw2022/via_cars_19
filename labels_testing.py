...
RESULTS_PATH = [ os.path.join('datasets/test_boxes', '{}'.format(i)) for i in results ]
...
for image_path in TEST_IMAGE_PATHS:
  ...
  if image_path.replace("test/", "test_boxes/") in RESULTS_PATH:
    continue
  else:
    ...
    plt.imshow(image_np)
    fig_path = image_path.replace("test/", "test_boxes/")
